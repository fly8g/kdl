...
class ListView
{
    ...
    function GetPageListST($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($totalpage<=1 && $this->TotalResult>0)
        {
            ...
            return "<a class=\"a1\">".$this->TotalResult."条</a>\r\n";
        }
        ...
        $purl = $this->GetCurUrl();
        $maininfo = "<a class=\"a1\">".$this->TotalResult."条</a>\r\n";
        ...
        if($this->PageNo != 1)
        {
            $prepage.="<a class=\"a1\" href='".str_replace("{page}",$prepagenum,$tnamerule)."'>上一页</a>\r\n";
            $indexpage="<a class=\"a1\" href='".str_replace("{page}",1,$tnamerule)."'>首页</a>\r\n";
        }
        else
        {
            $indexpage="<a class=\"a1\">首页</a>\r\n";
        }

        //下一页,未页的链接
        if($this->PageNo!=$totalpage && $totalpage>1)
        {
            $nextpage.="<a href='".str_replace("{page}",$nextpagenum,$tnamerule)."' class=\"a1\">下一页</a>\r\n";
            $endpage="<a href='".str_replace("{page}",$totalpage,$tnamerule)."' class=\"a1\">末页</a>\r\n";
        }
        else
        {
            $endpage="<a class=\"a1\">末页</a>\r\n";
        }
    ...
    function GetPageListDM($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($this->PageNo != 1)
        {
            $prepage.="<a href='".$purl."PageNo=$prepagenum' class=\"a1\">上一页</a>\r\n";
            $indexpage="<a href='".$purl."PageNo=1' class=\"a1\">首页</a>\r\n";
        }
        else
        {
            $indexpage="<a class=\"a1\">首页</a>\r\n";
        ...
        if($this->PageNo!=$totalpage && $totalpage>1)
        {
            $nextpage.="<a href='".$purl."PageNo=$nextpagenum' class=\"a1\">下一页</a>\r\n";
            $endpage="<a href='".$purl."PageNo=$totalpage' class=\"a1\">末页</a>\r\n";
        }
        else
        {
            $endpage="<a class=\"a1\">末页</a>\r\n";
